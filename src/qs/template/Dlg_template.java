...
import qs.template.Degrees.to_degrees;
...
//                btn_0.doClick();
    ...
    public static void loadData_degrees(List<to_degrees> acc) {
    ...
    public static class TbldegreesModel extends AbstractTableAdapter {
        ...
        public Object getValueAt(int row, int col) {
            to_degrees tt = (to_degrees) getRow(row);
            switch (col) {
                case 0:
                    return " " + tt.degree;
                case 1:
    ...
    private void ret_degrees() {
        String where = "";
        List<to_degrees> datas = Degrees.ret_data(where);
